...
const CFG = getConfig('mondial');
const PRODUCT_SLUG = '/en/products/gala-collection-rounded-earrings';
const PRODUCT_KEY = 'gala-collection-rounded-earrings';

test.describe.configure({ mode: 'serial' });

test.describe('Add to Wishlist — Mondial', () => {
