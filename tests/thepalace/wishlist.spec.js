...
const CFG = getConfig('thepalace');
const PRODUCT_SLUG = '/product/anting-sugar-rush-blue-round-huggie';
const PRODUCT_KEY = 'anting-sugar-rush-blue-round-huggie';

test.describe.configure({ mode: 'serial' });

test.describe('Add to Wishlist — The Palace', () => {
